...
// Modified work Copyright 2021, Yannick Gery  
...
function HttpCurtain(log, config) {
    ...
    this.curtainDirection = config.curtainDirection || 'left';
...
HttpCurtain.prototype = {
    ...
    getCurrentPosition: function (callback) {
        http.httpRequest(this.getCurrentPosUrl, (error, response, body) => {
            ...
            if (error) {
                ...
                if(this.curtainDirection != 'left') {
                    const posValue = 100 - parseInt(body);
                    // returns 90 but should be 10
                } else {
    ...
    setTargetPosition: function (value, callback) {
        ...
        if(this.curtainDirection != 'left') {
            this.targetPosition = 100 - parseInt(value);
            // returns 90 but should be 10
        } else {
